...
import { useGetMyGraph, useGetKnowledgeGraph } from "../hooks/useGraphs";
import { QuestionPage } from "../../questions";
import { ROUTES } from "../../../router";
import KnowledgeGraph2D from "./KnowledgeGraph3D";

export const MyGraphDetail: React.FC = () => {
  ...
  const handleViewKnowledgeGraph = () => {
    navigate(ROUTES.MY_GRAPH_3D(graphId!));
  };

  const handleViewNotes = () => {
    navigate(ROUTES.MY_GRAPH_NOTES(graphId!));
  };
  ...
  if (showQuiz && graphId) {
    return (
      <div className="min-h-screen bg-background-light dark:bg-background-dark">
        ...
        <QuestionPage graphId={graphId} isOwner={true} />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark font-display">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-gray-300 dark:border-gray-700 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm">
        <div className="container mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/my-graphs" className="text-text-primary-light dark:text-text-primary-dark text-sm font-medium">
              My Graphs
            </Link>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          <Link to="/my-graphs" className="text-text-secondary-light dark:text-text-secondary-dark text-sm font-medium hover:text-text-primary-light dark:hover:text-text-primary-dark transition-colors">
            My Graphs
          </Link>
          <span className="text-text-secondary-light dark:text-text-secondary-dark text-sm font-medium">/</span>
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-text-secondary-light dark:text-text-secondary-dark text-base leading-normal">
                Your personal knowledge graph with {graph.numOfKnowledgeNodes} interconnected concepts.
              </p>
            </div>
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark text-base leading-relaxed p-4 rounded-xl bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-gray-700">
              This is your personal knowledge graph. Navigate through concepts, test your understanding with quizzes, and visualize relationships in 3D.
            </p>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-xl">
                      ...
                      <p className="text-text-secondary-light dark:text-text-secondary-dark text-sm">
                        This is your personal knowledge graph containing {graph.numOfKnowledgeNodes} interconnected nodes representing key concepts and their relationships.
                      </p>
                    </div>
                    <div className="p-4 bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-xl">
                      <h3 className="text-text-primary-light dark:text-text-primary-dark font-medium mb-2">
