...
import { useGetMyGraphs, useCreateGraph } from "../hooks/useGraphs";
import { GraphCard } from "./GraphCard";
import { Navbar } from "../../../components/Navbar";
import type { CreateGraphRequestDTO } from "../types/graph";

export const MyGraphs: React.FC = () => {
  const { data: graphs, isLoading, isError, error } = useGetMyGraphs();
  const {
    mutate: createGraph,
  ...
  return (
    <div className="page-container">
      <Navbar showCreateButton onCreateClick={() => setIsModalOpen(true)} />
          ...
          <div className="flex-1">
            <div className="mb-6">
              ...
              <p className="text-text-secondary dark:text-text-secondary-dark mt-2">
                Manage your personal knowledge graphs
              </p>
            </div>
            ...
            {!isLoading && !isError && graphs && graphs.length > 0 && (
